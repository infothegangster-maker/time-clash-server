  ...
  var init_dist = __esm({
    "node_modules/@capacitor/core/dist/index.js"() {
      createCapacitorPlatforms = (win) => {
        ...
        const addPlatform2 = (name4, platform) => {
          capPlatforms.platforms.set(name4, platform);
        };
        const setPlatform2 = (name4) => {
          if (capPlatforms.platforms.has(name4)) {
            capPlatforms.currentPlatform = capPlatforms.platforms.get(name4);
          }
        };
...
<rect width="24" height="24" fill="white"/>
  ...
  // src/auth.js
  var firebaseConfig = {
    apiKey: "AIzaSyB8J8zu2Aiq5I3g4YGvRt3sv-MofmvhopE",
    // client[0].api_key[0].current_key
    authDomain: "time-clash-483314.firebaseapp.com",
    // project_id + .firebaseapp.com
    projectId: "time-clash-483314",
    // project_id
    storageBucket: "time-clash-483314.firebasestorage.app",
    messagingSenderId: "193117464708",
    // project_number
    appId: "1:193117464708:android:5562c30ed4f4e781593ad1"
    // mobilesdk_app_id
  };
  var app = initializeApp(firebaseConfig);
  var auth = getAuth(app);
  GoogleAuth.initialize({
    clientId: "193117464708-o38ipldvvsabo1ru9n2rb2okj5sn5dmk.apps.googleusercontent.com",
  ...
  async function signInWithGoogle() {
    try {
      ...
      console.log("Firebase Sign-In Success:", firebaseUser);
      localStorage.setItem("tc_user_id", firebaseUser.uid);
      localStorage.setItem("tc_email", firebaseUser.email);
      localStorage.setItem("tc_username", firebaseUser.displayName || "Time Clash Player");
      localStorage.setItem("tc_photo", firebaseUser.photoURL);
      localStorage.setItem("tc_auth_type", "google_firebase");
      // Store Firebase ID token for server-side verification
      const firebaseIdToken = await firebaseUser.getIdToken();
      localStorage.setItem("tc_id_token", firebaseIdToken);
